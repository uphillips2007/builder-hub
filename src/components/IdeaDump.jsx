      ...
      {ideas.length === 0 ? (
        ...
        <ul className="space-y-2.5">
          {ideas.map((idea) => (
            <li
              key={idea.id}
              className="flex items-start gap-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm hover:shadow-md hover:border-gray-200 dark:hover:border-gray-700 transition-all duration-150 group"
            >
              ...
              <button
                ...
                className="text-gray-300 dark:text-gray-700 hover:text-red-400 dark:hover:text-red-500 transition-colors duration-150 text-xl leading-none opacity-0 group-hover:opacity-100 shrink-0 mt-0.5"
                title="Delete"
              >
                ×
              </button>
